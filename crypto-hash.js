...
const cryptoHash = (...inputs)=>{
    ...
    //sorting is done to maintain the order of the hash in integrity so that come what may be hte orde to data passed to the function the hash remians same througout
    ...
    return '0x'+ hash.digest('hex')// return the outout in hexadecimal format
}
